...
(function() {
  var allScreen, meetScreen, resizeDiv, resizeStrata;

  resizeStrata = function() {
    return allScreen('.all-screen');
  };

  allScreen = function(element) {
    var height;
    height = $(window).height();
    return $(element).each(function() {
      var el;
      el = $(this);
      return el.height(height + "px");
    });
  };

  resizeDiv = function() {
    return meetScreen('.meet-screen', '.line-height-match');
  };

  meetScreen = function(element, line) {
    var height;
    height = $(window).height();
    return $(element).each(function() {
      var el, lineHeight;
      ...
      return $(line).each(function() {
        return $(this).css('line-height', lineHeight + "px");
      });
    });
  };
  ...
  $(function() {
    ...
    return $(window).resize(resizeDiv);
  });
...
(function() {
  ...
  pageScroll = function(link, target) {
  ...
  $(function() {
    return $('.page-jump').each(function() {
      var link, target;
      link = $(this);
      target = $('.jump-anchor');
      return pageScroll(link, target);
    });
  });

}).call(this);
(function() {
  var addEventListeners, fadeObject;

  fadeObject = function(fadeStart, fadeUntil) {
    var toFade;
    toFade = $('.js-fade-object');
    return $(window).bind('scroll', function() {
      var objOpacity, offset;
      ...
      if (offset <= fadeStart) {
        ...
        if (offset <= fadeUntil) {
          objOpacity = 1 - offset / fadeUntil;
        }
      }
      return toFade.css('opacity', objOpacity);
    });
  };

  addEventListeners = function() {
    return $('.js-fade-object').each(function() {
      var fadeStart, fadeUntil;
      fadeStart = $(this).data('fade-start');
      fadeUntil = $(this).offset().top + $(this).height() - 77;
      return fadeObject(fadeStart, fadeUntil);
    });
  };
...
(function() {
  var addEventListeners, colorObject;

  colorObject = function(colorStart, colorUntil) {
    var toColor;
    toColor = $('.nav--home');
    return $(window).bind('scroll', function() {
      var objOpacity, offset;
      ...
      if (offset <= colorStart) {
        ...
        if (offset <= colorUntil) {
          objOpacity = 0 + offset / colorUntil;
        }
      }
      return toColor.css('background-color', 'rgba(0,0,0,' + objOpacity + ')');
    });
  };

  addEventListeners = function() {
    return $('.nav--home').each(function() {
      var colorStart, colorUntil;
      colorStart = 0;
      colorUntil = 0 + $('.hero').height();
      return colorObject(colorStart, colorUntil);
    });
  };
